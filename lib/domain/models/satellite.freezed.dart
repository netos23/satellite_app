...
class _$SatelliteImpl implements _Satellite {
  ...
  @override
  String toString() {
    return 'Satellite(id: $id, name: $name, picture: $picture, resolution: $resolution, isSelected: $isSelected)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, picture, resolution, isSelected);
...
abstract class _Satellite implements Satellite {
  factory _Satellite(
      ...
      required final bool isSelected}) = _$SatelliteImpl;
